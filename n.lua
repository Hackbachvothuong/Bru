...
elseif World3 then
  PortalPos = {
    ...
    Vector3.new(5314.58203, 22.5364361, -125.942276, 1, 2.14762768e-08, -1.99111154e-13, -2.14762768e-08, 1, -3.0510602e-08, 1.98455903e-13, 3.0510602e-08, 1),
...
function TP2(Pos)
    if game.Players.LocalPlayer.Character.Humanoid.Health > 0 and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
        ...
        local itzHiru = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.PartTele, TweenInfo.new(Distance / getgenv().TweenSpeed, Enum.EasingStyle.Linear), {CFrame = Pos})
        itzHiru:Play()
    end
end    
...
DropdownTweenSpeed = Settings:AddDropdown("DropdownTweenSpeed", {
    Title = "Speed Tween",
    Values = {"100", "200", "300", "350", "400", "450", "500"},
    Multi = false,
    Default = 350,
})
...
Settings:AddParagraph({
        Title = "Please use Tween speed 300 - 350 if you farm,\nand use average speed to avoid being kicked",
    })
        ...
        while wait() do
            if _G.KillRipindra and World3 then
                ...
                elseif game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("God's Chalice") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("God's Chalice") then
                    repeat
                        TP2(CFrame.new(-5563.75048828125, 320.4276123046875, -2662.509521484375))
                ...
                elseif game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra True Form") then
                    TP2(game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra True Form").HumanoidRootPart.CFrame * Pos)
                end
            end
        end
    end)
